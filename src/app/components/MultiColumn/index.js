...
const MultiColumn = props => {
  ...
  return (
    ...
    >
        ...
        <Grid container>
            <Grid item lg={4} md={4} sm={6} xs={12} p={1}>
                <Box>
                    <Box
                    sx={{
                        // maxHeight: "100px"
            ...
            <Grid item lg={8} md={8} sm={6} xs={12} p={1}>
                <Box>
                        {
                            obj.collection == '' ?
                            <>
