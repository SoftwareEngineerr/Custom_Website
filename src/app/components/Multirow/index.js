...
const Multirow = props => {
    ...
    }, [obj.imagewidth , obj.imageheight , obj.desktop_content_position]); // Dependency on obj to reactively update the state when obj changes
